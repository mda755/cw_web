...
ActiveRecord::Schema.define(version: 20170601193503) do
  ...
  add_index "halls", ["name_short", "name_full"], name: "index_halls_on_name_short_and_name_full", unique: true, using: :btree
